...
`![Protocol Hierarchy Overview](Protocol_Hierarchy_Overview.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Protocol Hierarchy Overview`
...
`![IP Conversation Results](Identify_All_Hosts_IP_Conversation_Table.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Identify All Hosts (IP Conversation Table)`
...
`![DNS Query Extraction](Extract_DNS_Queries.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Extract DNS Queries`
...
`![DNS Response Extraction](Extract_DNS_Responses_Domain_to_IP_Resolution.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Extract DNS Responses (Domain → IP Resolution)`
...
`![Reconstruct Full FTP Session 1](Reconstruct_Full_FTP_Session_1.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Reconstruct Full FTP Session 1`
...
`![Reconstruct Full FTP Session 2](Reconstruct_Full_FTP_Session_2.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Reconstruct Full FTP Session 2`
> (See also: `Reconstruct Full FTP Sessions full session` for the combined session view)
...
`![Recover Exfiltrated Files from PCAP 1a](Recover_Exfiltrated_Files_from_PCAP_1a.png)`
`![Recover Exfiltrated Files from PCAP 1b](Recover_Exfiltrated_Files_from_PCAP_1b.png)`
> Source: `Phase 2 Screenshots-Network Investigation/Recover Exfiltrated Files from PCAP 1a` and `...1b`
> Also relevant: `Phase 1 Screenshots- Phishing Email/exfiltrated files from PCAP`
...
## Screenshot Index (Phase 2 Screenshots-Network Investigation folder)
...
> **Note:** Replace the placeholder image links above (e.g. `Protocol_Hierarchy_Overview.png`) with the actual exported screenshot files once copied into the same directory as this markdown file, keeping filenames consistent or updating the links to match.
